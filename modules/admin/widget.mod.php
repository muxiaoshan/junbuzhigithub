...
class ModuleObject extends MasterObject
{
    ...
    {
    	$sysm = array('admin_widget_guide','asker','broadcast','cservice','faq_invite','faq_my_bill','faq_my_coupon','faq_my_order','faq_ticket','follow_us','invite','my_account','product_list');
