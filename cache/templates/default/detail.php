...
<? } ?>
<? } ?>
<? } else { ?>已有<span><?=$product['succ_buyers']?></span>人购买，售出<span><?=$product['sells_count']?></span>份
<? } ?>
</b>
<br/>
<? if($product['time_remain'] < 0) { ?>
...
<? } else { ?>
<? if($product['surplus']<=0) { ?>
<img src="templates/default/images/err.gif" />
<span class="txt12">东西卖光啦，下次请赶早！</span>
<? } else { ?><span class="txt12">数量有限，行动要快哦！</span><br/>
<? if($product['succ_remain']<=0) { ?>
<img src="templates/default/images/sue.gif" style="vertical-align:middle"/>
<b class="R2">团购成功</b><br /><i class="B3">仍可继续购买</i>
<? } else { ?>达成团购还需<?=$product['succ_remain']?>人 <br/>
...
<div id="product_detail_area"  class="t_detail_l"
<? if(meta('p_hs_'.$product['id'])) { ?>
 style="width:711px;"
<? } else { ?> style="width:500px; overflow:hidden;"
<? } ?>
>
<h4>本单详情</h4>
